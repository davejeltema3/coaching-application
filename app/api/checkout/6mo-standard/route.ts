      ...
      line_items: [
        {
          price_data: {
            currency: 'usd',
            product_data: {
              name: 'BCP 6-Month Standard',
              description: '6 months of support • Monthly 1:1 calls • Instant chat • Weekly office hours • Private Discord',
            },
            unit_amount: 580000, // $5,800 in cents
          },
          quantity: 1,
        },
      ],
