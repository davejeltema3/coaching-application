...
export default function Alumni3moPremiumCheckout() {
  ...
  const paymentOptions = [
    ...
    },
    {
      ...
      description: '$2,625/mo for 2 months',
      amountCents: 262500,
      recurring: { totalCents: 525000 },
    },
    {
      id: '3x',
      label: '3 Monthly Payments',
      description: '$1,875/mo for 3 months',
      amountCents: 187500,
      recurring: { totalCents: 562500 },
    },
  ];
  ...
  const handleCheckout = async () => {
    ...
    try {
      const response = await fetch('/api/checkout/alumni/3mo-premium', {
        method: 'POST',
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-lg overflow-hidden shadow-xl">
          ...
          <div className="bg-gradient-to-r from-green-600/20 to-green-500/10 border-b border-slate-800 p-6 md:p-8">
            ...
            <p className="text-slate-300">The full Deep Dive experience with hands-on strategy and accountability.</p>
          </div>
