...
export default function AlumniThreeMonthPremiumCheckout() {
  return (
      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-8">
          <div className="inline-block px-3 py-1 bg-green-500/20 border border-green-500/50 rounded-full text-green-400 text-sm font-medium mb-4">
            Alumni Pricing - Save $1,500
          </div>
          <div className="text-5xl font-bold mb-2">$4,500</div>
          <div className="text-slate-400 line-through text-xl mb-6">$6,000</div>
          <h1 className="text-3xl font-bold mb-2">3 months</h1>
          <p className="text-xl text-slate-300">Boundless Creator Program</p>
          <p className="text-slate-400 mt-2">The full Deep Dive experience with hands-on strategy and accountability.</p>
        </div>
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-xl p-8 mb-8">
          ...
          <ul className="space-y-3">
            ...
            <li className="flex items-start gap-3">
              <CheckIcon />
              <span>3 monthly 1:1 accountability calls</span>
            </li>
            <li className="flex items-start gap-3">
              <CheckIcon />
