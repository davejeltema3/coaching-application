...
export default function Alumni6moMonthlyCheckout() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      const response = await fetch('/api/checkout/alumni/6mo-monthly');
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-lg overflow-hidden shadow-xl">
          ...
          <div className="bg-gradient-to-r from-green-600/20 to-green-500/10 border-b border-slate-800 p-6 md:p-8">
            ...
            <div className="text-green-400 text-sm font-medium mb-1">6 months</div>
          ...
          <div className="p-6 md:p-8 border-b border-slate-800">
            <div className="p-4 rounded-lg border-2 border-green-500 bg-green-500/10">
              <div className="flex items-center justify-between">
                <div>
                  <div className="font-semibold text-white">6 Monthly Payments</div>
                  <div className="text-sm text-slate-400 mt-0.5">$1,500/mo for 6 months</div>
                </div>
                <div className="text-right">
                  <div className="text-xl font-bold text-white">$1,500</div>
                  <div className="text-xs text-slate-500 mt-0.5">$9,000 total</div>
                  <div className="text-xs text-green-400 mt-0.5 line-through">$12,000</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mt-4 mb-8 text-center space-y-2">
          <p className="text-slate-500 text-xs">Your info stays private. No spam, no selling your data.</p>
