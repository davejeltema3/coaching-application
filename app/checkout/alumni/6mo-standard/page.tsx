...
export default function Alumni6moStandardCheckout() {
  ...
  const paymentOptions = [
    ...
    },
    {
      ...
      description: '$2,475/mo for 2 months',
      amountCents: 247500,
      recurring: { totalCents: 495000 },
    },
    {
      id: '3x',
      label: '3 Monthly Payments',
      description: '$1,800/mo for 3 months',
      amountCents: 180000,
      recurring: { totalCents: 540000 },
    },
  ];
  ...
  const handleCheckout = async () => {
    ...
    try {
      const response = await fetch('/api/checkout/alumni/6mo-standard', {
        method: 'POST',
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-lg overflow-hidden shadow-xl">
          ...
          <div className="bg-gradient-to-r from-green-600/20 to-green-500/10 border-b border-slate-800 p-6 md:p-8">
            ...
            <p className="text-slate-300">Six months of focused coaching to transform your channel.</p>
          </div>
